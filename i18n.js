...
var I18N = (function () {
  ...
  var dict = {
    ...
    'zones.intro1':        { zh: '依托完善的运输体系、强大的资源整合能力与覆盖全球的服务网络，我们不断拓展国际业务版图，为各地客户提供稳定、高效、专业的供应链与综合物流解决方案。多年来，我们持续优化供应链管理流程，整合全球物流资源，建立起科学高效的运输体系，让货物以更高的时效安全、准时地送达全球各地，全程透明、可控。', en: 'Built on a robust transport network, strong resource integration and a worldwide service footprint, we keep expanding our international reach to deliver stable, efficient and professional supply-chain and integrated logistics solutions. Over the years we have refined our processes, expanded our global resources and built a reliable transport system that moves goods safely and on time — with full visibility at every step.' },
    'zones.intro2':        { zh: '凭借成熟的物流框架与供应链策略，我们快速响应多元市场需求，帮助客户降低运营成本、提升效率，实现从起运地到目的地的无缝追踪。无论您是需要跨区域协作，还是布局全球市场，我们都能提供精准、高效的物流服务，让货物安全、快速地抵达全球目的地。', en: 'With mature logistics frameworks and supply-chain strategies, we respond quickly to diverse market needs — helping clients cut costs and move faster, while tracking every shipment seamlessly from origin to destination. Whether you need cross-regional cooperation or global expansion, we deliver precise, efficient logistics that gets your goods there safely and fast.' },
    ...
    'zones.oceania.desc':  { zh: '业务覆盖澳大利亚大陆，并连接新西兰、斐济、巴布亚新几内亚等南太平洋岛国。我们拥有自营仓储设施，提供端到端的全程物流，承接整箱（FCL）、拼箱（LCL）、散货及各类集装箱运输；资深清关团队负责商品归类、加固打板、门到门配送，直达海外买方，并配套提供供应链金融服务。', en: 'We cover mainland Australia and connect New Zealand, Fiji, Papua New Guinea and other South Pacific islands. With our own warehousing and end-to-end logistics, we handle full container (FCL), LCL, break-bulk and all container types. Our experienced customs team manages classification, cargo securing and door-to-door delivery straight to overseas buyers — plus integrated supply-chain finance.' },
    'zones.mideast.title': { zh: '中东及北非',                              en: 'Middle East & North Africa' },
    'zones.mideast.desc':  { zh: '专注连接中东、欧洲与非洲的核心贸易航线，在迪拜、多哈设有自营仓库，可辐射 GCC 各国及北非、东非、西非主要港口。我们承接大型基建项目，提供散货船租赁、大宗商品运输，以及门到港双清包税的一站式物流方案。', en: 'We focus on the key trade lanes linking the Middle East, Europe and Africa, with our own warehouses in Dubai and Doha serving GCC countries and major ports across North, East and West Africa. We support large infrastructure projects with bulk-vessel chartering and commodity shipping, plus door-to-port, tax-inclusive one-stop solutions.' },
    'zones.africa.title':  { zh: '非洲 — 全面覆盖',                         en: 'Africa — Full Coverage' },
    'zones.africa.desc':   { zh: '面向全球目的地，我们提供全方位的清关、单证与报关服务，包括整箱及拼箱海运订舱、拖车运输、单/双清包税等。我们的跨境物流一体化链条覆盖清关、拖车与末端配送，助力把握非洲蓬勃发展的基建与贸易机遇。', en: 'For destinations worldwide, we provide full customs clearance, documentation and declaration services — including FCL & LCL bookings, trucking and single/double-clearance tax packages. Our integrated cross-border chain covers clearance, haulage and last-mile delivery, unlocking Africa’s fast-growing infrastructure and trade opportunities.' },
