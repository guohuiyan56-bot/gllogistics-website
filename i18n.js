...
var I18N = (function () {
  ...
  var dict = {
    ...
    'logo':            { zh: '格林物流',       en: 'GREENLINE LOGISTICS' },
    ...
    /* ---- Contact page ---- */
    'contact.heading':     { zh: '格林物流',                 en: 'GREENLINE LOGISTICS' },
    ...
    /* ---- Footer ---- */
    'footer.company':      { zh: '格林物流——专业的国际货运代理与综合物流服务。', en: 'Professional international freight forwarding and integrated logistics services.' },
    ...
    'footer.copyright':    { zh: '© 2026 格林物流——国际货运代理。保留所有权利。', en: '&copy; 2026 GREENLINE LOGISTICS — International Freight Forwarding. All rights reserved.' },
    'footer.copyright.short': { zh: '© 2026 格林物流。保留所有权利。', en: '&copy; 2026 GREENLINE LOGISTICS — All rights reserved.' }
  };
